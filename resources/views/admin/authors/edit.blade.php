...
@section('title', 'Editar Autor - Admin')
...
<div class="max-w-3xl mx-auto px-4">
    ...
    <div class="bg-white rounded-lg shadow-lg p-8">
        <h1 class="text-3xl font-bold mb-6">Editar Autor: {{ $author->name }}</h1>
        ...
        <form action="{{ route('admin.authors.update', $author) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                @if($author->photo)
                    <div class="mb-4">
                        <img src="{{ asset('storage/' . $author->photo) }}" alt="{{ $author->name }}" class="w-32 h-32 object-cover rounded-lg">
